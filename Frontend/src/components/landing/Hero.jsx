const Hero = () => (
  <section className="mx-auto max-w-6xl px-5 pb-16 pt-20 text-center lg:px-8 lg:pb-20 lg:pt-28">
    ...
    <h1 className="mx-auto max-w-4xl text-4xl font-semibold tracking-[-0.045em] sm:text-6xl lg:text-7xl">
      Code deserves a<br />
      <span className="text-blue-600">second opinion.</span>
    </h1>
    <p className="mx-auto mt-6 max-w-xl text-sm leading-6 text-slate-500 dark:text-slate-400 sm:text-lg sm:leading-7">
