...
const Login = ({ darkMode, onToggleTheme }) => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            // Go directly to the protected Code Review page
                ...
                <section className="flex flex-col px-6 py-7 sm:px-12 sm:py-10 lg:px-14 lg:py-12">
                    ...
                    <div className="my-auto w-full max-w-md py-12">
                        ...
                        <p className="mt-3 text-sm leading-6 text-slate-500 dark:text-slate-400">
                            Continue reviewing code with a clearer, faster workflow.
                        </p>
                        ...
                        >
                            ...
                            <button
                                ...
                                className="flex h-11 w-full items-center justify-center gap-2 rounded-lg bg-blue-600 text-sm font-semibold text-white shadow-lg shadow-blue-600/20 transition hover:bg-blue-500 dark:bg-blue-600 dark:shadow-blue-600/20 dark:hover:bg-blue-500 disabled:cursor-not-allowed disabled:opacity-70"
                            >
                                {status === "loading"
                                    ? "Signing in..."
                                    : status === "success"
                ...
                <aside className="relative hidden overflow-hidden bg-gradient-to-br from-blue-50 via-white to-slate-100 dark:from-[#171129] dark:via-[#13151d] dark:to-[#10171b] lg:flex lg:items-center lg:justify-center">
                    ...
                    <div className="relative mx-10 max-w-md text-center">
                        ...
                        <div className="mx-auto mb-10 grid h-32 w-32 rotate-45 place-items-center rounded-3xl border border-blue-400/20 bg-blue-500/5 shadow-[0_0_80px_rgba(139,92,246,.2)]">
                            ...
                            <div className="-rotate-45 grid h-16 w-16 place-items-center rounded-2xl bg-blue-600 text-3xl shadow-[0_0_35px_rgba(37,99,235,.45)] dark:bg-blue-600 dark:shadow-[0_0_35px_rgba(139,92,246,.7)]">
                                ✦
                            </div>
                        ...
                        <p className="mt-4 text-sm leading-6 text-slate-500 dark:text-slate-400">
                            Keep your code quality moving forward with focused,
